...
- **Tools Used**
  ...
  - **PostgreSQL** – Preconfigured in CI environments to test database-related features.
  - **pytest / coverage** – Used for writing and running tests and generating code coverage reports.
